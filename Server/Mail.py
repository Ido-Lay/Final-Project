...
def check_email(current_event_map):
                        ...
                        if isinstance(response_part, tuple):
                            ...
                            try:
                                ...
                                if not confirmed_event:
                                    ...
                                    errors.append(f"Event ID {event_id} from email subject not in provided event_map.")
                                    mail.store(email_id_bytes, '+FLAGS', '\\Seen') # Mark as seen to avoid re-processing
                                ...
                                if ("confirm" in body_lower) or ("Confirm" in body_lower):
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            print(f"  - {error_msg}")
                                            errors.append(error_msg) # Still considered a success for main insertion
                                ...
                                try:
                                    ...
                                    errors.append(f"Could not mark email {email_id_str} as seen after parse error: {mark_seen_err}")
    ...
    confirmed_but_not_processed_explicitly = [
        ...
        if not any(s_msg in c for s_msg in insert_success + insert_failures) # check if core event part of c is in success/failure
    ]
    ...
    if (
        ...
        elif not (insert_success or denials_processed or insert_failures or confirmed_but_not_processed_explicitly) and email_ids:
